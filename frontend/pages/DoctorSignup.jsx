...
const DoctorSignup = () => {
  ...
  return (
    <div className={`max-w-4xl mx-auto p-6 rounded-lg shadow-md ${theme === 'dark' ? 'bg-gray-800 text-white' : 'bg-white text-gray-800'
      }`}>
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className={`w-full px-4 py-2 rounded-md ${theme === 'dark'
                  ...
                  } border focus:outline-none focus:ring-1 ${theme === 'dark' ? 'focus:ring-blue-500' : 'focus:ring-blue-600'
          ...
          <div>
            ...
            <h3 className={`text-lg font-medium mb-3 mt-6 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'
              }`}>Security</h3>
        ...
        <div className="mb-6 mt-4">
          ...
          <div className="flex items-center">
            {avatarPreview && (
              <div className={`w-24 h-24 rounded-full overflow-hidden mr-4 ${theme === 'dark' ? 'border border-gray-600' : 'border border-gray-300'
                }`}>
                <img
                  src={avatarPreview}
                  alt="Avatar preview"
            ...
            <div>
              ...
              <label
                htmlFor="avatar"
                className={`px-4 py-2 rounded cursor-pointer ${theme === 'dark'
        ...
        <div className="mt-6">
          <motion.button
            ...
            type="submit"
            disabled={isLoading}
            className={`w-full py-3 rounded-lg font-medium ${theme === 'dark'
      ...
      {showVerificationModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className={`p-6 rounded-lg max-w-md w-full ${theme === 'dark' ? 'bg-gray-800 text-white' : 'bg-white text-gray-800'
            }`}>
            ...
            <div className="flex mb-6 border-b border-gray-600">
              <button
                ...
                className={`flex-1 py-2 px-4 text-center ${verificationMethod === 'email'
                    ? theme === 'dark'
              ...
              <button
                ...
                className={`flex-1 py-2 px-4 text-center ${verificationMethod === 'phone'
                    ? theme === 'dark'
                      ? 'bg-gray-700 border-b-2 border-blue-500'
                      : 'bg-gray-100 border-b-2 border-blue-600'
                    : ''
